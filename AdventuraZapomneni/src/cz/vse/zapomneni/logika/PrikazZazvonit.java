...
public class PrikazZazvonit implements IPrikaz{
    ...
    public String provedPrikaz(String... parametry) {
        if (parametry.length == 0 && (herniPlan.getAktualniProstor().getNazev() == "kamaraduv_byt")) {
    ...
    } else if (parametry.length == 1 && (herniPlan.getAktualniProstor().getNazev() == "kamaraduv_byt")) {
